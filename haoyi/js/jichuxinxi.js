		...
		$.ajax({
			...
			success: function(result) {
				...
				if (result != null && result != '') {
					if (loginType == 1) {
						jichuxinxiTea(result);
					} else {
						jichuxinxiStu(result);
					}
				} else {
...
function jichuxinxiTea(result) {
	...
	var teach_course = data["teach_course"];//所教课程
	var html = '';
