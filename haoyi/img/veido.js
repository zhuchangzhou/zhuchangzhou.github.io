												...
												if(data.vpq.questionDescs!=null&&data.vpq.questionDescs.length>1){
													for(var i = 1;i<=data.vpq.questionDescs.length;i++){
														if(data.vpq.questionDescs[i]!=null&&data.vpq.questionDescs[i]!=''&&data.vpq.questionDescs[i]!=undefined){
															strrr+='<label style="font-size:12px;"><input name="que_ans" type="radio" value="'+i+'"/>'+data.vpq.questionDescs[i]+'</label><br>';
														}
													}
												}
													...
													success:function(data11){
														...
														if(data11.vpq.questionDescs!=null&&data11.vpq.questionDescs.length>1){
															for(var i = 1;i<=data11.vpq.questionDescs.length;i++){
																if(data11.vpq.questionDescs[i]!=null&&data11.vpq.questionDescs[i]!=''&&data11.vpq.questionDescs[i]!=undefined){
																	strrrr+='<label style="font-size:12px;"><input name="que_ans" type="radio" value="'+i+'"/>'+data11.vpq.questionDescs[i]+'</label><br>';
																}
															}
														}else{
															strrrr+='<label style="font-size:12px;"><input name="que_ans" type="radio" value="对"/>对</label><br>';
															strrrr+='<label style="font-size:12px;"><input name="que_ans" type="radio" value="错"/>错</label><br>';
														}
								 		     ...
								 		     $(".submit_ans").click(function(){
								 		    	...
								 		    	if($(".que_type").text().indexOf("判断")>-1){
								 		    		if(rightSelect.indexOf(que_ans)>-1){
									 		    		...
									 		    		$(".que_Check").find('img').attr('src','../yemian/img/right.png')
									 		    		errorState = 1;
									 		    	}else{
								 		    			$(".que_Check").css('display','inline-block');
								 		    			$(".que_Check").find('img').attr('src','../yemian/img/wrong.png')
								 		    			errorState = 2;
									 		    	}
								 		    	}else{
