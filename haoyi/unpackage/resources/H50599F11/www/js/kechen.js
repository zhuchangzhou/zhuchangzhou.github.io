	...
	window.Swipe = function(b, a) {
		...
		Swipe.prototype = {
			...
			slide: function(a, c) {
				...
				if (a * this.width > (Math.ceil((this.slides.length * this.lwidth) / this.width) - 1) * this.width/2) {
									b.MozTransform = b.webkitTransform = "translate3d(" + -((Math.ceil((this.slides.length*this.lwidth)/this.width)-1) * this.width)/2+ "px,0,0)";
