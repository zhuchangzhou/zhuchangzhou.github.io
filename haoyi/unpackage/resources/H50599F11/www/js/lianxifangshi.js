   ...
   $('.me_center_center').append(html);
    ...
    $(function(){
    	...
    	$('.shouji').click(function(){
    			...
    			window.location.href='shoujihaoma.html?data='+data;
    	});
    	
    	//邮箱
    	$('.email').click(function(){
    			var data=$('.me_center_center_input_email').text();
    			window.location.href='youxiangdizhi.html?data='+data;
    	});
    	//微信
    	$('.weixin').click(function(){
    			var data = $(".me_center_center_input_weixin").text();
    			window.location.href='weixinhaoma.html?data='+data;
    	});
			//qq
    	$('.qqNum').click(function(){
    			var data=$('.me_center_center_input_qq').text();
    			window.location.href='qqhaoma.html?data='+data;
    	});
    })
	//获取当前账户id
	//cookie开始
