...
function gerenziliao(result){
    ...
    if(ue_pic!=null && ue_pic!=''){
		html+='<div class="me_center_top_touxiang_main_div_img"><img class="me_center_top_touxiang_main_img" onerror="this.onerror=null;this.src=\'img/2.jpg\'"  src="'+ctx1+''+ue_pic+'" alt="First slide"/></div>'
	}else{
