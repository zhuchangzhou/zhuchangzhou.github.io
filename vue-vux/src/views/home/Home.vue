<template>
  <div style="height:100%;">
    <div style="position:fixed;width: 100%;z-index: 1;height:44px;background:#ffffff;">
      <div class="home_tab">
        <tab :line-width="2" custom-bar-width="60%" v-model="index" style="position:relative">
          <tab-item
            :key="item"
            :selected="tag === item"
...
import NewsListd from "./NewsListd";
...
export default {
  ...
  methods: {
    ...mapMutations([
      "set_app_is_loginApp",
      "set_home_tab_indexApp",
      "set_app_access_tokenApp",
      "set_app_user_infoApp",
      "set_app_user_typeApp",
      "get_home_tab_indexApp"
    ]),
    index_change() {
